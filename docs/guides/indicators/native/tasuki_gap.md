...
![Tasuki Gap — annotated preview mapping to core implementation](../../../assets/candlestick-previews/tasuki_gap.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Tasuki Gap indicator is a technical analysis tool that a continuation pattern involving a gap.
