...
![Doji Star — annotated preview mapping to core implementation](../../../assets/candlestick-previews/doji_star.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Doji Star indicator is a technical analysis tool that a reversal pattern where a doji gaps away.
