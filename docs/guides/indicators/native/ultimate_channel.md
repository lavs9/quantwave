...
The Ultimate Channel indicator is a technical analysis tool that a keltner-style channel using ultimatesmoothers for both the center line and the volatility range to minimize lag.
