...
![Ladder Bottom — annotated preview mapping to core implementation](../../../assets/candlestick-previews/ladder_bottom.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Ladder Bottom indicator is a technical analysis tool that a five-candle bullish reversal pattern.
