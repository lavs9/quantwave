...
![Stick Sandwich — annotated preview mapping to core implementation](../../../assets/candlestick-previews/stick_sandwich.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Stick Sandwich indicator is a technical analysis tool that a reversal pattern with alternating candle colors.
