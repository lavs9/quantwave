...
> **Chart**: Sparkline or annotated price series showing **Zero Lag Exponential Moving Average** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only zero_lag_exponential_moving_average` after extending the generator.
