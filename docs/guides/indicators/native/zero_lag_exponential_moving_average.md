...
The Zero Lag Exponential Moving Average indicator is a technical analysis tool that zlema attempts to eliminate the inherent lag associated with moving averages.
