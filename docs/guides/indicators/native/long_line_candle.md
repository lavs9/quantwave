...
> **Chart**: Annotated candlestick diagram for **Long Line Candle** showing the ideal TA-Lib recognition geometry (body/wick relationships and trend context). Extend `docs/gen_candle_previews.py` to add a dedicated generator for this pattern.
...
**Implementation**: `quantwave-core/src/indicators/pattern.rs` (`CDLLONGLINE` / `CDLLONGLINE_METADATA`).
...
**Parity**: `quantwave-core/tests/gold_standard/cdllongline.json`
