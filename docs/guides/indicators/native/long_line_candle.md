...
![Long Line Candle — annotated preview mapping to core implementation](../../../assets/candlestick-previews/long_line_candle.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Long Line Candle indicator is a technical analysis tool that a candle with an unusually long body.
