...
The FourierDominantCycle indicator is a technical analysis tool that dominant cycle period estimation using resolution-enhanced dft and center of gravity.
