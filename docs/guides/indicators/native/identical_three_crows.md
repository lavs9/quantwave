...
> **Chart**: Annotated candlestick diagram for **Identical Three Crows** showing the ideal TA-Lib recognition geometry (body/wick relationships and trend context). Extend `docs/gen_candle_previews.py` to add a dedicated generator for this pattern.
...
**Implementation**: `quantwave-core/src/indicators/pattern.rs` (`CDLIDENTICAL3CROWS` / `CDLIDENTICAL3CROWS_METADATA`).
...
**Parity**: `quantwave-core/tests/gold_standard/cdlidentical3crows.json`
