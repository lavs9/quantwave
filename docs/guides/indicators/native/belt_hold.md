...
![Belt-Hold — annotated preview mapping to core implementation](../../../assets/candlestick-previews/belt_hold.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Belt-Hold indicator is a technical analysis tool that a single candle pattern signaling a reversal.
