...
![Two Crows — annotated preview mapping to core implementation](../../../assets/candlestick-previews/two_crows.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Two Crows indicator is a technical analysis tool that a bearish reversal pattern consisting of three candles.
