...
![Mat Hold — annotated preview mapping to core implementation](../../../assets/candlestick-previews/mat_hold.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Mat Hold indicator is a technical analysis tool that a bullish continuation pattern.
