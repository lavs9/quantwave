...
The Correlation Coefficient (CORREL) indicator is a technical analysis tool that a statistical measure that determines the degree to which two securities move in relation to each other.
