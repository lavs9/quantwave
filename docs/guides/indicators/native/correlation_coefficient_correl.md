...
> **Chart**: Sparkline or annotated price series showing **Correlation Coefficient (CORREL)** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only correlation_coefficient_correl` after extending the generator.
