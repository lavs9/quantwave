...
![Closing Marubozu — annotated preview mapping to core implementation](../../../assets/candlestick-previews/closing_marubozu.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Closing Marubozu indicator is a technical analysis tool that a candle with no shadow at the closing end.
