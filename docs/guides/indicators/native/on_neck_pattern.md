...
![On-Neck Pattern — annotated preview mapping to core implementation](../../../assets/candlestick-previews/on_neck_pattern.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The On-Neck Pattern indicator is a technical analysis tool that a bearish continuation pattern.
