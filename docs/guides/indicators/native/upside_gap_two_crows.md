...
![Upside Gap Two Crows — annotated preview mapping to core implementation](../../../assets/candlestick-previews/upside_gap_two_crows.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Upside Gap Two Crows indicator is a technical analysis tool that a bearish reversal pattern.
