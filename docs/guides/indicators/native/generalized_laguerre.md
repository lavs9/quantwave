...
The Generalized Laguerre indicator is a technical analysis tool that a generalized laguerre filter of arbitrary order using an ultimatesmoother as the primary component.
