...
> **Chart**: Sparkline or annotated price series showing **FourierSeriesModel** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only fourierseriesmodel` after extending the generator.

*Visual placeholder — standards bulk upgrade 2026-06-25 IST. Core logic in `quantwave-core/src/indicators/fourier_series.rs`.*
