...
The Commodity Channel Index (CCI) indicator is a technical analysis tool that a versatile indicator that can be used to identify a new trend or warn of extreme conditions.
