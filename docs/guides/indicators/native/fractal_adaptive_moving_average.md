...
![Fractal Adaptive Moving Average — annotated preview mapping to core implementation](../../../assets/indicator-previews/fractal_adaptive_moving_average.png)
...
- Allow `16`+ bars warm-up for filter state to stabilise
