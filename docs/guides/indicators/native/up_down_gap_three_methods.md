...
![Up/Down-Gap Three Methods — annotated preview mapping to core implementation](../../../assets/candlestick-previews/up_down_gap_three_methods.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Up/Down-Gap Three Methods indicator is a technical analysis tool that a continuation pattern.
