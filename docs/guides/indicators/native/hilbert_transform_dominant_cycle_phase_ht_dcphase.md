...
> **Chart**: Sparkline or annotated price series showing **Hilbert Transform - Dominant Cycle Phase (HT_DCPHASE)** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only hilbert_transform_dominant_cycle_phase_ht_dcphase` after extending the generator.
