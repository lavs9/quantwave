...
![Kicking — annotated preview mapping to core implementation](../../../assets/candlestick-previews/kicking.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Kicking indicator is a technical analysis tool that a two-candle reversal pattern involving a gap.
