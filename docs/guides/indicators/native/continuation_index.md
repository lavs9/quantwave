...
The Continuation Index indicator is a technical analysis tool that an oscillator that identifies trend onset and exhaustion by comparing a fast ultimatesmoother with a generalized laguerre filter.
