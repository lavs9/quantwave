...
![Morning Doji Star — annotated preview mapping to core implementation](../../../assets/candlestick-previews/morning_doji_star.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Morning Doji Star indicator is a technical analysis tool that a bullish reversal pattern involving a doji.
