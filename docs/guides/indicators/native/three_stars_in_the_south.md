...
> **Chart**: Annotated candlestick diagram for **Three Stars In The South** showing the ideal TA-Lib recognition geometry (body/wick relationships and trend context). Extend `docs/gen_candle_previews.py` to add a dedicated generator for this pattern.
