...
> **Chart**: Sparkline or annotated price series showing **True Range** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only true_range` after extending the generator.
