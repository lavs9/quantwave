...
> **Chart**: Sparkline or annotated price series showing **Butterworth2** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only butterworth2` after extending the generator.
