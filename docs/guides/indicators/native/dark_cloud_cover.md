...
![Dark Cloud Cover — annotated preview mapping to core implementation](../../../assets/candlestick-previews/dark_cloud_cover.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Dark Cloud Cover indicator is a technical analysis tool that a bearish reversal pattern in an uptrend.
