...
![Spinning Top — annotated preview mapping to core implementation](../../../assets/candlestick-previews/spinning_top.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Spinning Top indicator is a technical analysis tool that a candle with a small body and long shadows.
