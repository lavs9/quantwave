...
![Hilbert Transform - Phasor Components (HT_PHASOR) — annotated preview mapping to core implementation](../../../assets/indicator-previews/hilbert_transform_phasor_components_ht_phasor.png)
