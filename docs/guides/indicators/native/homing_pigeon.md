...
![Homing Pigeon — annotated preview mapping to core implementation](../../../assets/candlestick-previews/homing_pigeon.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Homing Pigeon indicator is a technical analysis tool that a bullish reversal pattern in a downtrend.
