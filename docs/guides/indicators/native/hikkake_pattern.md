...
![Hikkake Pattern — annotated preview mapping to core implementation](../../../assets/candlestick-previews/hikkake_pattern.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The Hikkake Pattern indicator is a technical analysis tool that a trap pattern used to identify false breakouts.
