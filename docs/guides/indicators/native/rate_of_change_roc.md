...
> **Chart**: Sparkline or annotated price series showing **Rate of Change (ROC)** behaviour on synthetic trending + cyclic data. Run `python docs/gen_indicator_previews.py --only rate_of_change_roc` after extending the generator.
