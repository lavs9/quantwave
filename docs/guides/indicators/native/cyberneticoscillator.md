...
![CyberneticOscillator — annotated preview mapping to core implementation](../../../assets/indicator-previews/cyberneticoscillator.png)

*Synthetic ideal per library logic. Generated 2026-06-25 IST via `docs/generate_all_previews.py` (reproducible; maps to core `Next<T>` implementation).*

## Description

The CyberneticOscillator indicator is a technical analysis tool that combined highpass and supersmoother filters normalized by rms.
