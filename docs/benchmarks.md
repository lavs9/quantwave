...
<!-- bench:meta:start -->
**Last harness run:** 2026-09-06T10:23:43.741057+00:00
**Harness version:** 2
...
|-----------|------|-----------|
| SMA (20) | streaming | 5.4124 |
| RSI (14) | streaming | 0.0000 |
| SuperTrend (10,3) | streaming | 7.1071 |
...
|---------|-----------|
| QuantWave (.ta) | 8.0597 |
| Polars rolling_mean | 8.8292 |
| Pandas rolling | 10.8329 |
| TA-Lib | _not installed_ |

**Library versions:** numpy 2.5.2, pandas 3.0.5, pandas_ta not_installed, polars 1.44.1, quantwave 0.7.0, talib not_installed
