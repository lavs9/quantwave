...
- **Native Indicators landing page & structure (quantwave-shtm, closed 2026-06-01 IST)**: Strong professional landing page created in `docs/guides/indicators/native/index.md` (multiple iterations + final polish with featured high-value areas and specific recommended starting indicators). Sidebar structure significantly improved via reorganization of the Native section in SUMMARY.md into 8 logical groups (Price Action & Geometric Patterns prominently featured and aligned with the landing page). Directly resolved the original problems of weak/missing index and lack of clear organization. Related docs updated. Task closed as substantially complete (broader page enforcement tracked under 6br5).
